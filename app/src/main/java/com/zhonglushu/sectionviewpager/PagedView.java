...
public abstract class PagedView extends ViewGroup implements ViewGroup.OnHierarchyChangeListener {
    ...
    // Begin, added to inidcate whether fling to judge animation, 20161108
    protected boolean bFling = false;
    // End
    ...
    public interface PageSwitchListener {
        ...
        void onVelocityChange(int velocity, int deltaX);

        void onScrollBying(int deltaX, int deltaY);
    ...
    protected void init() {
        ...
        //setDefaultInterpolator(new BounceOutInterpolator());
        mCurrentPage = 0;
    ...
    protected boolean computeScrollHelper() {
        if (mScroller.computeScrollOffset()) {
            if (mPageSwitchListener != null) {
                mPageSwitchListener.onScrollChanged();
            }
    ...
    protected void getVisiblePages(int[] range) {
        ...
        if (pageCount > 0) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                mTmpIntPoint[0] = 0;
                getDescendantCoordRelativeToParent(currPage, this, mTmpIntPoint, false);
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_DOWN: {
                ...
                for (int j = 0; j < childCount; j++) {
                    ...
                    float toLeft = child.getLeft() - getScrollX();
                    if (mDownMotionX > toLeft && mDownMotionX < toLeft + child.getWidth()) {
                        mCurrentPageIndex = j;
                        break;
                    }
                }//End
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (mTouchState == TOUCH_STATE_SCROLLING) {
                    ...
                    if (Math.abs(deltaX) >= 1.0f) {
                        ...
                        /*if (mPageSwitchListener != null) {
                            mPageSwitchListener.onScrollBying((int) deltaX, 0);
                        }*/
            ...
            case MotionEvent.ACTION_UP:
                ...
                /*if (mPageSwitchListener != null) {
                    mPageSwitchListener.onVelocityChange(velocityX, deltaX);
                }*/
    ...
    protected void snapToPageWithVelocity(int whichPage, int velocity) {
        ...
        duration = 800;//4 * Math.round(1000 * Math.abs(distance / velocity));
